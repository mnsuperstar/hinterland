ActiveAdmin.register Adventure do
  ...
  permit_params :uid, :short_uid, :title, :description, :inclusions,
                ...
                adventure_images_attributes: [:id, :order_number, :file, :_destroy], activity_ids: [],
  ...
  form do |f|
    ...
    f.inputs do
      f.input :is_featured
      f.input :is_listed
      f.input :guide, as: :select, collection: User.guides.map { |u| [u.name, u.id] },
